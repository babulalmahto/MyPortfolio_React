    ...
    >
      <div className="max-w-screen-lg p-4 mx-auto flex flex-col justify-center w-full h-full">
        ...
        <p className="text-xl mt-20">
          Welcome to my portfolio! I'm a 2020 MCA post graduate
          from Central University Of Karnataka, and I've embarked on a journey into
          the world of MERN Stack Web Development. With a strong foundation in
          problem-solving and analytical thinking, my BCA/MCA background
